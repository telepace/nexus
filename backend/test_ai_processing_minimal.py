        ...
        async with httpx.AsyncClient(timeout=10.0) as client:
            ...
            try:
                ...
                if health_response.status_code == 200:
                    ...
                    print(f"   ❌ LiteLLM 代理健康检查失败: {health_response.status_code}")
                    return False
            ...
            test_payload = {
                "model": model,
                "messages": [{"role": "user", "content": "Hello, this is a test. Please respond with 'AI working'."}],
                "max_tokens": 50,
                "temperature": 0.1
            }
            ...
            try:
                chat_response = await client.post(chat_url, json=test_payload, headers=headers)
                ...
                if chat_response.status_code == 200:
                    ...
                    print(f"   ❌ AI请求失败: {chat_response.status_code} - {chat_response.text}")
                    return False
