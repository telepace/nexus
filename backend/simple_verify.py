...
def check_content_card_file():
    """检查ContentCard.tsx文件"""
    file_path = Path("../frontend/app/(withSidebar)/content-library/components/ContentCard.tsx")
...
def main():
    ...
    if all(results):
        print("🎉 All tests passed! AI regeneration functionality appears to be correctly implemented.")
        return 0
    else:
