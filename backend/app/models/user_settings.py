...
class UserSettingsBase(SQLModel):
    ...
    # 偏好设置
    preferred_analysis_model: Optional[str] = Field(default=None, description="偏好的分析模型")
...
class UserSettingsUpdate(SQLModel):
    """更新用户设置请求模型"""
    ai_output_language: Optional[str] = Field(default=None, description="AI 输出语言偏好")
    auto_generate_summary: Optional[bool] = Field(default=None, description="是否自动生成摘要")
    auto_generate_key_points: Optional[bool] = Field(default=None, description="是否自动生成要点")
    auto_generate_labels: Optional[bool] = Field(default=None, description="是否自动生成标签")
    preferred_analysis_model: Optional[str] = Field(default=None, description="偏好的分析模型")
    max_summary_length: Optional[int] = Field(default=None, description="摘要最大长度")
