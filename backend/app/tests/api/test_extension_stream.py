...
class TestExtensionStreamAPI:
    ...
    def test_summary_stream_success(self, client: TestClient, normal_user_token_headers: dict):
        """测试流式摘要接口成功返回"""
        payload = {
    ...
    def test_keypoints_stream_success(self, client: TestClient, normal_user_token_headers: dict):
        """测试流式要点接口成功返回"""
        payload = {
    ...
    def test_stream_with_empty_text(self, client: TestClient, normal_user_token_headers: dict):
        """测试空文本的验证错误"""
        payload = {
            "text": "",
            "lang": "zh"
    ...
    def test_stream_language_auto_detection(self, client: TestClient, normal_user_token_headers: dict):
        """测试语言自动检测功能"""
        payload = {
    ...
    def test_stream_response_format(self, client: TestClient, normal_user_token_headers: dict):
        """测试流式响应格式符合SSE标准"""
        payload = {
            "text": "测试内容用于验证流式响应格式",
            "lang": "zh",
