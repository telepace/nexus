...
def test_get_users_superuser_me(
    ...
    current_user = get_api_response_data(r)
    assert current_user
...
def test_create_user_new_email(
    ...
    with (
        ...
        created_user = get_api_response_data(r)
...
def test_get_existing_user(
    ...
    assert 200 <= r.status_code < 300
    api_user = get_api_response_data(r)
...
def test_create_user_existing_username(
    ...
    assert "error" in created_user or "detail" in created_user
...
def test_retrieve_users(
    ...
    all_users = get_api_response_data(r)
