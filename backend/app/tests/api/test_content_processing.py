...
class TestContentProcessingAPI:
    ...
    def test_process_content_item_text(self, client: TestClient, db: Session, normal_user_token_headers):
    ...
    def test_process_content_item_url(self, mock_get, client: TestClient, db: Session, normal_user_token_headers):
    ...
    def test_process_content_item_not_found(self, client: TestClient, normal_user_token_headers):
    ...
    def test_process_content_item_unsupported_type(self, client: TestClient, db: Session, normal_user_token_headers):
    ...
    def test_process_already_completed_content(self, client: TestClient, db: Session, normal_user_token_headers):
    ...
    def test_process_content_item_unauthorized(self, client: TestClient, db: Session, superuser_token_headers, normal_user_token_headers):
