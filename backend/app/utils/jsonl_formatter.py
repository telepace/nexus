...
class FormatterConfig:
    ...
    custom_separators: Optional[Dict[str, str]] = None
    encoding: str = "utf-8"
...
class JsonlFormatter:
    ...
    def _format_single_block(self, block: ParsedBlock) -> Optional[str]:
        """格式化单个块"""
        # 构建输出字典
        output_dict = {}
    ...
    def _create_fallback_block(self, block: ParsedBlock, error_msg: str) -> Optional[str]:
        """创建错误恢复块"""
        fallback_dict = {
