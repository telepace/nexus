...
from app.schemas.extension import ExtensionStreamRequest, ExtensionStreamChunk
...
class ExtensionStreamService:
    ...
    async def generate_summary_stream(
        ...
        # 检测语言
        detected_lang = self.detect_language(request.text) if request.lang == "auto" else request.lang
