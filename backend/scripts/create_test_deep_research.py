...
from app.crud.crud_content import get_content_chunks  # noqa: E402
from app.models.content import ContentItem, DeepResearchJob, Segment  # noqa: E402
from app.services.deep_research_service import deep_research_service  # noqa: E402
from app.utils.timezone import now_utc  # noqa: E402
...
async def verify_results(job_id: uuid.UUID):
    ...
    with Session(engine) as session:
        ...
        statement = select(ContentItem).where(
            ContentItem.source_uri == f"deep_research:{job_id}"
        )
