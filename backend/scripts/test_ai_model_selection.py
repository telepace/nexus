...
async def test_model_selection():
    ...
    test_context = {
        ...
        """,
        "document_metadata": {"title": "人工智能发展概述", "content_type": "article"},
    }
...
async def test_preprocessing_pipeline_integration():
    ...
    try:
        ...
        metadata = DocumentMetadata(
            title="AI技术发展测试文档", content_type=ContentType.ARTICLE, language="zh"
        )
        ...
        result = await pipeline.process_content(content=test_content, metadata=metadata)

        logger.info("✅ 预处理管道执行成功")
