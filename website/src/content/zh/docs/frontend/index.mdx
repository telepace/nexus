---
title: 前端开发
description: nexus 中 Next.js 和 React 前端架构概述。
---

# 前端开发

nexus 前端使用 Next.js、TypeScript 和 React 构建，提供现代、类型安全的用户界面。本节涵盖前端架构、关键组件以及如何根据您的需求扩展前端。
...
nexus 的前端遵循 Next.js App Router 结构：
...
nexus 使用 Zustand 进行状态管理，这是一个轻量级且易于使用的状态管理库。
...
nexus 使用 Tailwind CSS 进行样式设计，这是一个实用优先的 CSS 框架。
...
nexus 使用 Jest 和 React Testing Library 进行测试。
