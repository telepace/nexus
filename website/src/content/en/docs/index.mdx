...
description: Documentation for the nexus project - a production-ready fullstack template for rapid AI prototype development.
---

# nexus Documentation

Welcome to the official documentation for nexus - a production-ready fullstack template combining FastAPI (Python) and TypeScript for rapid AI prototype development. This documentation will help you get started with the project, understand its architecture, and guide you through development and deployment.

## What is nexus?

nexus is designed for freelancers and AI entrepreneurs who need to quickly build and deploy professional applications with modern development practices. It provides a solid foundation that combines:
