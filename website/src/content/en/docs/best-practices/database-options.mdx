...
description: Learn how to configure and switch between PostgreSQL and Supabase database options in nexus
category: Best Practices
---

# Database Configuration Options

nexus supports two database deployment options, giving you flexibility in your development and production environments:
...
nexus now automatically detects which database to use based on your environment variables:
...
nexus uses Alembic for database migrations, which works with both PostgreSQL direct deployment and Supabase.
...
nexus implements this feature through:
...
By supporting both options, nexus gives you the flexibility to choose the right database approach for your specific needs and project phase. 