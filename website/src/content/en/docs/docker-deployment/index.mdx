...
description: Learn how to containerize and deploy your nexus application to various environments.
---

# Docker and Deployment

This guide will help you understand how to containerize your nexus application and deploy it to various environments.

## Docker Setup

nexus comes with pre-configured Docker support to make containerization easy and consistent across environments.
...
nexus can be deployed to various platforms:
...
cd helm-charts
helm install nexus ./nexus --values ./your-values.yaml
```
...
# Deploy the stack
docker stack deploy -c docker-compose.yml -c docker-compose.prod.yml nexus
```
