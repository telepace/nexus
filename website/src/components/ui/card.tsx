 ...
 *
 * Applies layout and spacing styles suitable for arranging card header content, including support for an optional action area.
 */
...
/**
 * Renders the title section of a card with emphasized typography.
 *
 ...
 *
 * Spreads additional div props onto the root element and merges any provided className with default styles.
 */
...
/**
 * Renders the footer section of a card with horizontal alignment and padding.
 *
 * Spreads additional props onto the root div and merges custom class names with default styling.
 */
