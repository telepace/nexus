...
description: 'Overview of FastAPI backend architecture in nexus'
---

# Backend Development

The nexus backend is built with FastAPI, a modern, high-performance web framework for building APIs with Python. This section covers the backend architecture, key components, and how to extend the backend as needed.
