---
title: 数据库配置选项
description: 学习如何在 nexus 中配置和切换 PostgreSQL 和 Supabase 数据库选项
category: 最佳实践
---

# 数据库配置选项

nexus 支持两种数据库部署选项，为您的开发和生产环境提供灵活性：
...
nexus 使用 Alembic 进行数据库迁移，它适用于直接 PostgreSQL 部署和 Supabase。
...
通过支持这两个选项，nexus 让您可以灵活选择适合您特定需求和项目阶段的正确数据库方法。
