---
title: 'FastAPI开发流程'
description: 'nexus中FastAPI的开发流程和最佳实践'
---

# FastAPI开发流程

本文档介绍了在nexus项目中使用FastAPI进行后端开发的完整流程、环境设置和最佳实践。

## 开发环境架构

下图展示了nexus后端开发环境的整体架构：
...
nexus使用Docker Compose管理开发环境，包括FastAPI后端和PostgreSQL数据库。
