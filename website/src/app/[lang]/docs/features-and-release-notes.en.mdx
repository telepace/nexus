...
description: An overview of the main features of nexus and a record of important changes across versions.
---

# Features and Release Notes

This document provides a comprehensive overview of the main features of nexus and tracks important changes across versions. It aims to give developers a clear understanding of the template's capabilities and how they evolve over time.
