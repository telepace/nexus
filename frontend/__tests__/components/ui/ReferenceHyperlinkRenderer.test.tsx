...
describe('ReferenceHyperlinkRenderer', () => {
  ...
  describe('maxVisible prop', () => {
    it('should limit visible references and show overflow count', () => {
      render(<ReferenceHyperlinkRenderer refString="1,2,3,4,5,6" maxVisible={3} />);
  ...
  describe('interaction', () => {
    it('should call onReferenceClick when clicked', () => {
      ...
      render(<ReferenceHyperlinkRenderer refString="1" onReferenceClick={mockClick} />);
  ...
  describe('complex reference patterns', () => {
    ...
    it('should handle large reference sets gracefully', () => {
      ...
      render(<ReferenceHyperlinkRenderer refString={largeRefString} maxVisible={5} />);
  ...
  describe('accessibility', () => {
    it('should have proper ARIA labels', () => {
      ...
      links.forEach((link, index) => {
        expect(link).toHaveAttribute('aria-label', expect.stringContaining('跳转到第'));
      });
    });
