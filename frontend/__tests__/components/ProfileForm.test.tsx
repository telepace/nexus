...
jest.mock('lucide-react', () => ({
  ...
  Edit2: ({ className, ...props }: any) => <div data-testid="edit2-icon" className={className} {...props} />,
...
jest.mock('@/components/ui/button', () => ({
  Button: ({ children, onClick, className, variant, size, type, disabled, ...props }: any) => (
    <button 
      onClick={onClick}
      className={className}
      type={type}
...
jest.mock('@/components/ui/input', () => ({
  Input: ({ className, onChange, value, disabled, type, id, ...props }: any) => (
    <input
      className={className}
      onChange={onChange}
      value={value}
