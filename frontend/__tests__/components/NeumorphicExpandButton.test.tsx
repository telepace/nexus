...
describe('NeumorphicExpandButton', () => {
  ...
  it('applies custom className', () => {
    const { container } = render(<NeumorphicExpandButton className="custom-class" />);
  ...
  it('has correct neumorphic styling', () => {
    ...
    expect(button).toHaveClass('shadow-[5px_5px_10px_#c2c2c2,-5px_-5px_10px_#ffffff]');
  });
  ...
  it('shows active/pressed state styling', () => {
    ...
    const button = screen.getByRole('button');
    expect(button).toHaveClass('active:shadow-[inset_5px_5px_10px_#c2c2c2,inset_-5px_-5px_10px_#ffffff]');
  });
});