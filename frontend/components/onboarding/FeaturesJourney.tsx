  ...
  const journeySteps = [
    {
      ...
      description: "支持文件拖拽、链接粘贴、浏览器插件等多种方式，让内容收集变得简单自然。",
      features: [
        { icon: FileText, text: "拖拽文件上传", detail: "支持 PDF、Word、TXT 等格式" },
        { icon: Link2, text: "一键保存链接", detail: "智能抓取网页核心内容" },
        { icon: Globe, text: "浏览器插件", detail: "随时随地保存有价值的内容" }
      ],
      visual: "📁→📄→💾"
    },
    {
      ...
      description: "强大的 AI 引擎深度理解内容语义，自动分段、提取要点、生成摘要。",
      features: [
        { icon: Layers, text: "智能分段", detail: "按主题自动划分内容结构" },
        { icon: Lightbulb, text: "要点提取", detail: "自动识别关键信息和观点" },
    ...
    },
    {
      ...
      description: "以卡片流的形式展示处理后的内容，快速浏览和筛选真正有价值的信息。",
      features: [
        { icon: Newspaper, text: "卡片式布局", detail: "清晰展示摘要和要点" },
        { icon: ArrowRight, text: "快速筛选", detail: "一键标记重要、稍后、归档" },
        { icon: Globe, text: "多维分类", detail: "按主题、来源、时间智能分组" }
      ],
      visual: "📋→👀→✅"
    },
    {
      ...
      features: [
        { icon: MessageCircle, text: "智能问答", detail: "基于内容的深度对话" },
        { icon: Lightbulb, text: "洞察发现", detail: "挖掘内容间的关联和启发" },
    ...
    },
    {
      ...
      description: "将有价值的内容和洞察整理成个人知识库，构建属于自己的知识体系。",
      features: [
        { icon: BookMarked, text: "笔记整理", detail: "结构化保存重要内容和思考" },
        { icon: Network, text: "知识图谱", detail: "可视化展示知识间的关联" },
        { icon: Layers, text: "体系构建", detail: "从点到面，形成完整认知框架" }
      ],
      visual: "📝→🕸️→🏗️"
    }
  ];
                ...
                <div className="space-y-4">
                  {step.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-medium text-foreground">{feature.text}</h4>
              ...
              <div className={`${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                <Card className="h-80 relative overflow-hidden group hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-8 h-full flex flex-col items-center justify-center">
                    ...
                    <div className={`w-full h-2 bg-gradient-to-r ${step.color} rounded-full mb-4 opacity-20`} />
