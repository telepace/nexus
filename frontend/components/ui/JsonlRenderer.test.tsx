...
describe("JsonlRenderer", () => {
  ...
  describe("Block Types", () => {
    it("renders h1 blocks correctly", () => {
      const content =
        '{"type": "h1", "content": "Main Title", "mapping": "h1-1"}';
    ...
    it("renders h2 blocks correctly", () => {
      const content =
        '{"type": "h2", "content": "Section Title", "mapping": "h2-1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders h3 blocks correctly", () => {
      const content =
        '{"type": "h3", "content": "Subsection Title", "mapping": "h3-1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders paragraph blocks correctly", () => {
      const content =
        '{"type": "p", "content": "This is a paragraph.", "mapping": "p1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders quote blocks correctly", () => {
      const content =
        '{"type": "quote", "content": "Important quote", "mapping": "q1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders list blocks with array content", () => {
      const content =
        '{"type": "list", "content": ["Item 1", "Item 2", "Item 3"], "mapping": "l1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders insight blocks with normal priority", () => {
      const content =
        '{"type": "insight", "content": "Important insight", "mapping": "i1"}';
      render(<JsonlRenderer content={content} />);

      const insight = screen
        .getByText("Important insight")
    ...
    it("renders insight blocks with high priority", () => {
      const content =
        '{"type": "insight", "content": "Critical insight", "priority": "high", "mapping": "i2"}';
      render(<JsonlRenderer content={content} />);

      const insight = screen
        .getByText("Critical insight")
        .closest('div[class*="border-l-4"]');
    ...
    it("renders concept blocks correctly", () => {
      const content =
        '{"type": "concept", "content": "Key concept definition", "mapping": "c1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders qa blocks with object content", () => {
      const content =
        '{"type": "qa", "content": {"q": "What is this?", "a": "This is an answer."}, "mapping": "qa1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders qa blocks with alternative object keys", () => {
      const content =
        '{"type": "qa", "content": {"question": "Alternative question?", "answer": "Alternative answer."}, "mapping": "qa2"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders qa blocks with string content fallback", () => {
      const content =
        '{"type": "qa", "content": "Simple QA text", "mapping": "qa3"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders action blocks correctly", () => {
      const content =
        '{"type": "action", "content": "Take this action", "mapping": "a1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("renders unknown block types as paragraphs", () => {
      const content =
        '{"type": "unknown", "content": "Unknown block type", "mapping": "u1"}';
      render(<JsonlRenderer content={content} />);
  ...
  describe("Alternative Field Names", () => {
    it("supports short field names (t, c)", () => {
      const content =
        '{"t": "h2", "c": "Short field names", "mapping": "short1"}';
      render(<JsonlRenderer content={content} />);
    ...
    it("prioritizes full field names over short ones", () => {
      const content =
        '{"type": "h1", "t": "h2", "content": "Full names win", "c": "Short content", "mapping": "priority1"}';
      render(<JsonlRenderer content={content} />);
