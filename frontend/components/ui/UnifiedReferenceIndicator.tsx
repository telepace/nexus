...
const VISUAL_VARIANTS = {
  minimal: {
    ...
    hover:
      "hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-gray-200 hover:border-gray-300 dark:hover:border-gray-600",
    active: "active:bg-gray-300 dark:active:bg-gray-600",
    focus:
      "focus:ring-2 focus:ring-gray-400 dark:focus:ring-gray-500 focus:ring-offset-1",
  },

  standard: {
    base: "bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-700",
    hover:
      "hover:bg-blue-100 dark:hover:bg-blue-800/40 hover:text-blue-800 dark:hover:text-blue-200 hover:border-blue-300 dark:hover:border-blue-600",
    active: "active:bg-blue-200 dark:active:bg-blue-700/50",
    focus:
      "focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-500 focus:ring-offset-1",
  },
...
const UnifiedReferenceIndicator = forwardRef<
  HTMLButtonElement,
  UnifiedReferenceIndicatorProps
>(
  (
    {
      refId,
    ...
    const animation = useIndicatorAnimation({
      duration: loading
        ? REFERENCE_ANIMATIONS.INDICATOR.duration * 2
        : undefined,
    });
    ...
    return (
      ...
      >
        {/* 主要内容 */}
        <span className="relative z-10">{refId}</span>
...
// 便捷的预设组件
export const MinimalReference = (
  props: Omit<UnifiedReferenceIndicatorProps, "variant">,
) => <UnifiedReferenceIndicator {...props} variant="minimal" />;

export const StandardReference = (
  props: Omit<UnifiedReferenceIndicatorProps, "variant">,
) => <UnifiedReferenceIndicator {...props} variant="standard" />;

export const ElegantReference = (
  props: Omit<UnifiedReferenceIndicatorProps, "variant">,
...
export const BatchReferenceIndicator: React.FC<
  BatchReferenceIndicatorProps
> = ({
  refIds,
  contentId,
  variant = "standard",
