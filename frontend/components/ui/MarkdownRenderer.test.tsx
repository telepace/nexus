...
describe('MarkdownRenderer', () => {
  it('renders markdown content', () => {
    ...
    expect(screen.getByTestId('react-markdown')).toHaveTextContent('This is a **bold** text.')
  })
  ...
  it('renders code blocks', () => {
    ...
    expect(screen.getByTestId('react-markdown')).toHaveTextContent('```javascript')
    expect(screen.getByTestId('react-markdown')).toHaveTextContent('const hello = "world";')
  })
...
`
  ...
  it('renders links', () => {
    ...
    expect(screen.getByTestId('react-markdown')).toHaveTextContent('[Google](https://google.com)')
  })
