...
// Hook 实现
export const useKeyboardNavigation = (options: KeyboardNavigationOptions): KeyboardNavigationReturn => {
  const {
    refId,
    contentId,
    onActivate,
...
// 便捷的预设 Hook
export const useSimpleKeyboardNav = (refId: number, contentId: string, onActivate?: (refId: number) => void) => {
...
export const useFullKeyboardNav = (refId: number, contentId: string, onActivate?: (refId: number) => void) => {
  return useKeyboardNavigation({
    refId,
    contentId,
    onActivate,
