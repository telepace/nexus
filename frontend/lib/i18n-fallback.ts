...
const fallbackTranslations: Record<string, string> = {
  ...
  "content.aiAnalysisStarted":
    "AI analysis started, please check results later",
  "content.aiAnalysisFailed": "AI analysis failed, please try again later",
  "content.aiAnalysisRegenerateStarted":
    "AI analysis regeneration started, please check results later",
  "content.aiAnalysisRegenerateFailed":
    "Failed to regenerate AI analysis, please try again later",
