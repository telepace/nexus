...
export function formatRelativeTime(
  ...
  try {
    ...
    // 转换到目标时区
    const zonedDate = toZonedTime(parsedDate, timeZone);
    const zonedBaseDate = baseDate ? toZonedTime(baseDate, timeZone) : toZonedTime(new Date(), timeZone);
 ...
 * @returns UTC时间
 */
export function toUTC(date: Date, timeZone: TimeZone = getBrowserTimeZone()): Date {
 ...
 * @returns 时区时间
 */
export function fromUTC(date: Date, timeZone: TimeZone = getBrowserTimeZone()): Date {
