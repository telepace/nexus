      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <div className="space-y-2 text-blue-700 dark:text-blue-300">
            <p>
              • <strong>Prompt 场景:</strong> 优先显示 Prompt
              名称，让用户清楚知道使用了哪个模板
            </p>
            <p>
              • <strong>手动输入:</strong>{" "}
              智能清理用户输入，移除冗余词汇，保留核心问题
            </p>
            <p>
              • <strong>长文本:</strong>{" "}
              智能截断，优先在句子边界处截断，保持语义完整
            </p>
            <p>
              • <strong>问题格式:</strong> 自动识别问题类型，优化问题表述
            </p>
            <p>
              • <strong>展开讨论:</strong> 保留完整的讨论主题，确保上下文清晰
            </p>
          </div>
        </div>
      </div>
