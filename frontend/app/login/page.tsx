    ...
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md mb-8 relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-300">Log in</h1>
        </div>
        ...
        <Card className="w-full rounded-xl shadow-lg border border-slate-200/50 dark:border-slate-700/50 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm transition-all duration-300 hover:shadow-blue-100 dark:hover:shadow-blue-900/20">
          <CardContent className="pt-6 px-6">
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="relative z-10">
              ...
              <span className="text-sm text-slate-800 dark:text-slate-200 font-medium relative z-10">Continue with Google</span>
            </Button>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs text-slate-600 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-400 transition-colors duration-300"
                  >
                    Forgot password?
                  </Link>
                </div>
