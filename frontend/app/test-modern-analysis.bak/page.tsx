...
const mockContent: ContentItemPublic = {
  ...
  summary:
    "这篇文章记录了作者熊鑫伟在2024年的深刻人生转变历程，从离开外企舒适圈到拥抱旅居生活的思考与感悟。",
  ...
  ai_analysis: {
    summarizer: {
      summary:
        "这篇文章记录了作者熊鑫伟在2024年的深刻人生转变历程，从确定性到拥抱未知，从理论到实践，从个人成长到社会价值的探索。",
...
const mockAnalysisResult: AIResult = {
  ...
  summary:
    "这篇文章记录了作者熊鑫伟在2024年的深刻人生转变历程，从确定性到拥抱未知的思考与感悟。",
  key_points: [
    "核心转变：从确定性到拥抱未知",
    "认知升级：从理论到实践",
    "价值重构：从个人成长到社会价值",
