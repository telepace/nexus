 ...
 */
export type AIConversationCreate = {
...
export type ContentGetContentProcessingJobsError = HTTPValidationError;
...
export type ContentGetContentAiConversationsData = {
  path: {
    content_id: string;
  };
  query?: {
...
export type ContentGetContentAiConversationsResponse = {
  [key: string]: unknown;
};

export type ContentGetContentAiConversationsError = HTTPValidationError;

export type ContentGetAiConversationDetailsData = {
  path: {
    conversation_id: string;
  };
};

export type ContentGetAiConversationDetailsResponse = {
  [key: string]: unknown;
};

export type ContentGetAiConversationDetailsError = HTTPValidationError;
