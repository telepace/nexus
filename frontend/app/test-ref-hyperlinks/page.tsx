...
import {
  ...
  GlowReferences,
  BounceReferences,
} from "@/components/ui/AnimatedReferenceIndicator";
import {
  SmartReferenceHighlighter,
  ReferenceHighlightManager,
} from "@/components/ui/SmartReferenceHighlighter";
          ...
          <div className="max-w-6xl mx-auto p-6 space-y-8">
            ...
            <Card className="border-2 border-dashed border-purple-200 dark:border-purple-800">
              ...
              <CardContent>
                <div className="flex flex-wrap gap-3">
                  {(["default", "minimal", "badge", "inline"] as const).map(
                    (style) => (
                      <Button
                        key={style}
                        variant={
            ...
            <Card className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-green-200 dark:border-green-800">
              ...
              <CardContent className="text-green-700 dark:text-green-300 space-y-2">
                <p>
                  • <strong>ref格式支持:</strong> "1" (单个), "1-3" (范围),
                  "1,3,5" (多个), "1-3,5,7-9" (混合)
                </p>
                <p>
                  • <strong>四种风格:</strong> default (圆形徽章), minimal
                  (简约文本), badge (彩色徽章), inline (内联链接)
                </p>
                <p>
                  • <strong>智能分组:</strong> 自动将连续数字合并为范围显示，如
                  [1,2,3,5] → "1-3, 5"
                </p>
                <p>
                  • <strong>交互体验:</strong>{" "}
                  悬停效果、工具提示、点击跳转、键盘导航支持
                </p>
                <p>
                  • <strong>响应式设计:</strong> 适配不同屏幕尺寸，支持明暗主题
                </p>
              </CardContent>
            </Card>
          </div>
