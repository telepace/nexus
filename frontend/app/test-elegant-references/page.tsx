          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">展示不同变体和尺寸的引用指示器</p>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                  <span className="text-sm font-medium w-16">Minimal:</span>
                  <MinimalReference refId={1} contentId={sampleContentId} size="sm" />
                  <MinimalReference refId={2} contentId={sampleContentId} size="md" />
                  <MinimalReference refId={3} contentId={sampleContentId} size="lg" />
                </div>
                
                <div className="flex items-center gap-4">
                  <span className="text-sm font-medium w-16">Standard:</span>
                  <StandardReference refId={4} contentId={sampleContentId} size="sm" />
                  <StandardReference refId={5} contentId={sampleContentId} size="md" />
                  <StandardReference refId={6} contentId={sampleContentId} size="lg" />
                </div>
                
                <div className="flex items-center gap-4">
                  <span className="text-sm font-medium w-16">Elegant:</span>
                  <ElegantReference refId={7} contentId={sampleContentId} size="sm" />
                  <ElegantReference refId={8} contentId={sampleContentId} size="md" />
                  <ElegantReference refId={9} contentId={sampleContentId} size="lg" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">展示批量引用的显示和折叠功能</p>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
          ...
          <div className="space-y-8">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">测试悬浮预览和点击模态框功能</p>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">展示不同的配置选项</p>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
          ...
          <div className="space-y-8">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">自动处理文本中的引用标记</p>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">模拟真实使用场景中的复杂情况</p>
              </CardHeader>
              <CardContent>
...
/>`}
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                    <li>• <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-xs">悬浮</kbd> 引用数字查看预览</li>
                    <li>• <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-xs">点击</kbd> 引用数字打开详情</li>
                    <li>• <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-xs">Tab</kbd> 键可以聚焦引用</li>
                    <li>• <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-xs">Enter</kbd> 键激活聚焦的引用</li>
                    <li>• <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-xs">ESC</kbd> 键关闭模态框</li>
                    <li>• 模态框支持拖拽移动</li>
                  </ul>
                </div>
              </CardContent>
