  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-linear-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 p-4 relative overflow-hidden">
      <div className="absolute w-full h-full pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 bg-grid-slate-200/50 dark:bg-grid-slate-700/20 bg-size-[30px_30px] mask-[radial-gradient(ellipse_80%_80%_at_50%_50%,#000_20%,transparent_100%)]" />
      </div>

      <div className="w-full max-w-md z-10 relative">
        <form onSubmit={handleSubmit}>
          <div className="text-card-foreground w-full max-w-sm shadow-lg border border-slate-200/50 dark:border-slate-700/50 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xs rounded-xl">
            <div className="flex flex-col p-6 space-y-1 pb-2">
              ...
              <h3 className="tracking-tight text-2xl font-bold text-center bg-clip-text text-transparent bg-linear-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-300">
                重置您的密码
              </h3>
            ...
            <div className="p-6 grid gap-4 pt-2">
              ...
              <div className="grid gap-2">
                ...
                <div className="relative group">
                  <div className="absolute -inset-0.5 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg blur-sm opacity-0 group-hover:opacity-100 transition duration-500" />
                  <Input
                    id="password"
                    name="password"
                    type="password"
              ...
              {!success && (
                <div className="relative group mt-2">
                  <div className="absolute -inset-0.5 bg-linear-to-r from-blue-600 to-indigo-600 dark:from-blue-500 dark:to-indigo-500 rounded-lg blur-sm opacity-75 group-hover:opacity-100 transition duration-300" />
                  <button
                    type="submit"
                    className="relative inline-flex items-center justify-center w-full h-10 px-4 py-2 text-sm font-medium text-white bg-blue-600 dark:bg-blue-600 rounded-md shadow-sm hover:bg-blue-700 dark:hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-blue-400 disabled:opacity-50"
                    disabled={isPending}
                  >
                    {isPending ? "处理中..." : "重置密码"}
                  </button>
