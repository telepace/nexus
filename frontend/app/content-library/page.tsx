  ...
  return (
    <MainLayout pageTitle="Content Library" fullscreen>
      ...
      <div className="flex h-screen overflow-hidden bg-gradient-to-br from-background via-background to-muted/20">
        {/* 左栏 */}
        <section className="lg:w-1/2 flex flex-col overflow-y-auto overflow-x-hidden no-scrollbar px-6">
          {/* Header 仅存在于左栏 */}
        ...
        {/* 右栏 */}
        <aside className="lg:w-1/2 p-2 flex h-screen overflow-hidden">
